...
bmr = NutritionCal.calculate_bmr_from_lean_body_mass(weight, body_fat_percent)
tdee = NutritionCal.calculate_total_daily_energy_expenditure(bmr, activity_level)
